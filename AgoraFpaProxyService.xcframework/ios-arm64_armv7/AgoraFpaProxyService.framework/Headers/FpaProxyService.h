...
@property (nonatomic, assign) BOOL enableCrypto;

@property (nonatomic, copy) NSArray<NSString *> * _Nullable userCas;

@property (nonatomic, copy) NSString * _Nullable verifyHost;
