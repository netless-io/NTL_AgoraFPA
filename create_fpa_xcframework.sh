...
# Fix version
/usr/libexec/PlistBuddy -c "Add :CFBundleShortVersionString string $(/usr/libexec/PlistBuddy -c "Print CFBundleShortVersionString" libs/ALL_ARCHITECTURE/AgoraFPA.framework/Info.plist)" libs/ALL_ARCHITECTURE/AgoraFpaProxyService.framework/Info.plist
...
/bin/rm -rf ./AgoraFPA.xcframework
/bin/rm -rf ./AgoraFpaProxyService.xcframework
